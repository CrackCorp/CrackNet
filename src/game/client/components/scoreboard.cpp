...
void CScoreboard::OnRender()
{
	...
	if(m_pClient->m_Snap.m_pGameDataObj)
	{
		...
		else
		{
			...
			if(m_pClient->m_Snap.m_pGameDataObj->m_GameStateFlags&GAMESTATEFLAG_GAMEOVER && m_pClient->m_Snap.m_pGameDataObj)
			{
				char aText[256];
...
bool CScoreboard::Active()
{
	...
	// if the game is over
	if(m_pClient->m_Snap.m_pGameDataObj && m_pClient->m_Snap.m_pGameDataObj->m_GameStateFlags&GAMESTATEFLAG_GAMEOVER)
		return true;
